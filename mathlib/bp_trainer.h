...
class bp_trainer {
    ...
    template <size_t... I>
    static auto helper_network_data(std::index_sequence<I...>) -> decltype(std::make_tuple(
 ...
 private:
    ...
    class pass_weights {
        ...
        static auto helper_layer_params(std::index_sequence<I...>) -> decltype(std::make_tuple(
    ...
    template <>
    inline value_t sum_error<output_size>(const typename Network::output_t&) {
        return 0;
    }
