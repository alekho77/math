...
TEST_F(bp_trainer_test_fixture, forward_pass) {
  ...
  const auto expected_state = std::make_tuple(std::make_tuple(0.610639233949222, 0.6856801139382539), std::make_tuple(0.3404913400038911));
...
TEST_F(bp_trainer_test_fixture, back_pass_deltas) {
  ...
  const auto expected_deltas = std::make_tuple(std::make_tuple(0.05281718211874069, -0.07341221444187529), std::make_tuple(0.148097277843866));
