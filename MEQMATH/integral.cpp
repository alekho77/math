...
Extended __fastcall Integral(TIntPar* IntPar) {
    switch (IntPar->IntMeth) {
        case miRectangle:
            return IntMethRect(IntPar->F, IntPar->A, IntPar->B, IntPar->Abs, IntPar->Eps, IntPar->iErr,
                               IntPar->RealEps);
        case miTrapezoid:
            return IntMethTrap(IntPar->F, IntPar->A, IntPar->B, IntPar->Abs, IntPar->Eps, IntPar->iErr,
                               IntPar->RealEps);
        case miSimpson:
            return IntMethSimp(IntPar->F, IntPar->A, IntPar->B, IntPar->Abs, IntPar->Eps, IntPar->iErr,
                               IntPar->RealEps);
        default:
            IntPar->iErr = 1;
    }
